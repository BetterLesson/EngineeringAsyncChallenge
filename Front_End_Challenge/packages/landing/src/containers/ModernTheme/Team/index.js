...
import { SectionHeader, CircleLoader } from '../modernTheme.style';
...
import { teamData } from 'common/data/ModernTheme';

const Team = () => {
  const { slogan, members } = teamData;
                      ...
                      <TeamCard className="team_card">
                        ...
                        <TextWrapper className="text_wrapper">
                          <div className="name_plate">
                            ...
                            <Text content={member.availableDate} />
                          </div>
